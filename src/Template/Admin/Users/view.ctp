...
<div class="related row">
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td><?= h($need['n_id']) ?></td>
            <td><?= h($need['n_user_id']) ?></td>
            <td><?= h($need['n_product_id']) ?></td>
            <td><?= h($need['n_quantity']) ?></td>
            <td><?= h($need['n_creation_date']) ?></td>
            ...
            <td class="actions">
				...
				<?= $this->Form->postLink(__('Delete'), ['controller' => 'Needs', 'action' => 'delete', $need['n_id']], ['confirm' => __('Are you sure you want to delete # {0}?', $need['n_id'])]) ?>
            </td>
        </tr>
